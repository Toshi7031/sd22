    <form method="post" enctype="multipart/form-data">
      <p class="green">商品画像<span class="error_mes"><?php echo $error_mes['image'];?></span></p>
        ...
        <ul>
          ...
          <li>
            <select name="large_product_category_id">
              ...
              <option value="1"<?php $input['large_product_category_id']==1?' selected':'';?>>レディース</option>
              <option value="2"<?php $input['large_product_category_id']==2?' selected':'';?>>メンズ</option>
              <option value="3"<?php $input['large_product_category_id']==3?' selected':'';?>>キッズ</option>
              <option value="4"<?php $input['large_product_category_id']==4?' selected':'';?>>インテリア・住まい</option>
              <option value="5"<?php $input['large_product_category_id']==5?' selected':'';?>>家電</option>
              <option value="6"<?php $input['large_product_category_id']==6?' selected':'';?>>ホビー・娯楽</option>
              <option value="7"<?php $input['large_product_category_id']==7?' selected':'';?>>ハンドメイド</option>
            </select><br>
